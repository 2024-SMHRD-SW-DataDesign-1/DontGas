...
public class SecurityConfig {
	...
	public WebSecurityCustomizer WebSecurityCustomizer() {
		return (web) -> web.ignoring().requestMatchers("/static/**"); // 정적 리소스에는 Security 코드를 적용하지 않게 만들기
	}
...
//				.requestMatchers("/", "/join", "/login", "/api/member/join").permitAll() // 얘네는 굳이 인증을 하지 않아도 접근을 허용하겠음
